...
#  Pour détecte automatiquement le dossier du script
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

# Les chemins sont maintenant TOUJOURS relatifs au script
SOURCE_DIR = os.path.join(BASE_DIR, "Data_test")    # → Changer en "Data_full" plus tard
